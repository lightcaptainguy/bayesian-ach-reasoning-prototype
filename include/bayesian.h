...
double uncondprob(vector<Hypotheses>& hypotheses, vector<Weight>& Weights);
...
void posteriorvalue(vector<Hypotheses>& hypotheses, vector<Weight>& Weights, double probB);